...
BOOST_AUTO_TEST_SUITE(Base32Rfc4648TestCase)
...
SimpleBaseLibStringArray EncodedData = SimpleBaseLibStringArray({ "", "MY======", "MZXQ====",
...
IBase32 base32 = SimpleBaseFactory::CreateBase32Rfc4648();
